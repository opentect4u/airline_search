...
class FlightsController extends Controller
{
    public function search(Request $request){
        ...
        if($request->travel_class != 'All'){
            $searchLegModifier = ' <air:AirLegModifiers>
              	<air:PreferredCabins>
              	<com:CabinClass xmlns="http://www.travelport.com/schema/common_v48_0" Type="'. $request ->travel_class.'"></com:CabinClass>
              	</air:PreferredCabins>
              </air:AirLegModifiers>';
        }
   ...
   <soapenv:Body>
      <air:LowFareSearchReq ReturnUpsellFare="true" TraceId="trace" AuthorizedBy="user" SolutionResult="true" TargetBranch="'.$TARGETBRANCH.'" xmlns:air="http://www.travelport.com/schema/air_v48_0" xmlns:com="http://www.travelport.com/schema/common_v48_0">
        ...
        '. $returnSearch .'
		 ...
		 <com:SearchPassenger BookingTravelerRef="1" Code="ADT" xmlns:com="http://www.travelport.com/schema/common_v48_0"/>
