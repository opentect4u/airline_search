        ...
        <div class="container-fluid">
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <span class="float-right h6 font-weight-600"><i class="las la-pound-sign"></i>{{number_format($GST,2)}}</span>
                    </p>
                    <p class="text-dark">Convenience Fees
                    <span class="float-right h6 font-weight-600"><i class="las la-pound-sign"></i>{{number_format($Convenience_Fees,2)}}</span>
                    </p>
                    <p class="text-dark">Taxes & Fees
                    <span class="float-right h6 font-weight-600"><i class="las la-pound-sign"></i>{{number_format($Taxes_and_Fees,2)}}</span>
                    </p><hr>
                    <p class="mb-4 font-weight-600">Total<span class="text-danger float-right"><i class="las la-pound-sign"></i>{{ number_format(( $searched->price+$GST+$Convenience_Fees+$Taxes_and_Fees),2) }}</span></p>
                </div>
            </div>
            @endif
        </div>
